...
while True:
	...
	#nadanie nazw wspolrzednym srodkow i polaczenie ich
	#give names of points co-ordinates and conect them
	    ...
	    #count length and angle between arms
